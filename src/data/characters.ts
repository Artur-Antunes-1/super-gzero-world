...
export const CHARACTERS: Record<string, CharacterDef> = {
  ...
  dante: {
    ...
    abilityName: 'Dash Criativo',
    abilityDesc: 'Investida rápida e invencível',
    color: COLOR_BLUE,
    accent: COLOR_LIME,
    hearts: 3,
    jumpVelMul: 1.0,
  ...
  julio: {
    ...
    abilityName: 'Escudo de Governança',
    abilityDesc: 'Bloqueia dano enquanto durar',
    color: COLOR_VIOLET,
  ...
  artur: {
    ...
    abilityId: 'builder',
    abilityName: 'Builder',
    abilityDesc: 'Constrói um bloco temporário',
    color: COLOR_LIME,
    accent: COLOR_BLUE,
    hearts: 3,
    jumpVelMul: 1.0,
  ...
  einstein: {
    ...
    abilityId: 'emc2',
    abilityName: 'E=mc²',
    abilityDesc: 'Desacelera o tempo do mundo',
    color: COLOR_TEXT,
